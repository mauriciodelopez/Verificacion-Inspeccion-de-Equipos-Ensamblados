document.addEventListener('DOMContentLoaded', function() {
    const descriptions = [
        ...
        "e) Verificación de mangueras neumáticas, garantizar un  solo punto de conexión neumática general.", "f) Verificación de corazas que no interfieran con funcionamiento ni izaje del equipo", "g) Verificación placa de marcado equipo", "h) Verificación de correcta aplicación de pintura"  
