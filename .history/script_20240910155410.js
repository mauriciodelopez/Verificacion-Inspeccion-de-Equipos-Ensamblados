document.addEventListener('DOMContentLoaded', function() {
    const descriptions = [
        ...
        "c) Verificación de manómetros", "d) Verificación de niveladores", "e) Verificación de mangueras neumáticas, garantizar un  solo punto de conexión neumática general.", "f) Verificación de corazas que no interfieran con funcionamiento ni izaje del equipo", "g) Verificación placa de marcado equipo", "h) Verificación de correcta aplicación de pintura", "Verificación dimensional con plano ( antes de pintura) = Distancias según plano de fabricación respetando las tolerancias establecidas en el plano.", "b) Verificación de paralelismo  y perpendicularidad en todas las tuberías del equipo: Línea suministro de vapor", "Línea drenaje de separador", "Línea agua bomba a intercambiador", "Línea agua entrada a bomba", "Línea reposición de agua", "Línea venteo de aire en agua", "Línea vapor motriz", "Línea venteo de trampa bomba", "Tanque colector de trampa bomba", "Tanque Pulmón de agua", "c) Verificación orientación agujeros de bridas", "d) Verificación estructura dimensional", "e) Verificación de componentes del ensamble y direcciones de flujo", "f) Verificación de soportes, cantidad nivel , paralelismo y escuadra", "g) Verificación de tapones", "h) Verificación de palancas que no tengan interferencia", "2. Pruebas o inspecciones de uniones soldadas: Prueba de estanqueidad", "b) Inspección visual de soldaduras", "c) Inspección por líquidos penetrantes", "d) Otra:", "3. Verificación después de pintura: a) Verificación de calibración o correcto funcionamiento (válvula actuada o válvula de control)", "b) Verificación instalación tablero eléctrico y pruebas simuladas", "c) Verificación de manómetros", "d) Verificación de niveladores", "e) Verificación de mangueras neumáticas, garantizar un  solo punto de conexión neumática general.", "f) Verificación de corazas que no interfieran con funcionamiento ni izaje del equipo", "g) Verificación placa de marcado equipo", "h) Verificación de correcta aplicación de pintura"  
